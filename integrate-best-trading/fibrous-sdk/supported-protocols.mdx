...
description: 'Fetch a list of protocols supported by Fibrous Finance api'
---

The `supportedProtocols` function returns a list of protocols (AMMs) that are supported by Fibrous Finance on a specific chain.
