...
<AccordionGroup>
  <Accordion title="quote" icon="tag">
    **Category:** Read-Only
    ...
    3. After quoting, offer `trade` as the execution step, noting that it does require a session.
  ...
  <Accordion title="config" icon="gear">
    **Category:** Utility
    ...
    2. Settings are stored in `~/.config/fibx/config.json` and persist across sessions.
