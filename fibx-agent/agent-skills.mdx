...
<Note>
  Skills require Node.js 18+ and are compatible with fibx CLI v0.3.5 and above.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="aave" icon="building-columns">
    **Category:** DeFi
    ...
    Manages Aave V3 lending positions on **Base only** — supply, borrow, repay, withdraw, and health factor monitoring. The CLI automatically handles ETH ↔ WETH wrapping and unwrapping for `supply`, `repay`, and `withdraw` actions.
