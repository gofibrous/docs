...
<CardGroup cols={2}>
  ...
  <Card title="Agent Skills" icon="robot">
    Eight pre-built skills that allow AI agents to authenticate, check balances, inspect portfolios, trade, send, manage Aave positions, verify transactions, and configure RPC endpoints — all through natural language.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="npm Package" icon="npm" href="https://www.npmjs.com/package/fibx">
    fibx v0.5.1 — install and version history
  </Card>
  <Card title="Agent Skills" icon="github" href="https://github.com/Fibrous-Finance/fibx-skills">
    Eight pre-built skills for AI agent integration
  </Card>
