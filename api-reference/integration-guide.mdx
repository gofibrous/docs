...
<Warning>
  **API Key Required for Integrator Features**: To use integrator features (fee or surplus sharing), you MUST obtain an API key from Fibrous. Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/). Without an API key, integrator parameters will be ignored and normal swap functionality will be used.
...
- Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/) for increased rate limits
...
<Warning>
  **API Key Required**: Integrator features (fee or surplus sharing) require an API key from Fibrous. Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/). If you don't have an API key, use normal swap functionality.
</Warning>
...
- **Integrator Features (if using)**:
  - API key from the [Fibrous Partnership Portal](https://portal.fibrous.finance/)
