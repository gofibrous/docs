...
<Tabs>
  ...
  <Tab title="Starknet">
    ...
    ```
    <Note>Starknet has additional batch routing capabilities. See [Starknet API](/api-reference/starknet/endpoint/overview) for details.</Note>
  </Tab>
</Tabs>
...
<ParamField query="tokenInAddress" type="string" required>
  ...
  <Tabs>
    <Tab title="Base/HyperEVM/Scroll/Monad">
...
<ParamField query="slippage" type="number" default="0.5">
...
<ParamField query="direct" type="boolean" default="false">
