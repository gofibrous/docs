...
Route endpoint finds the optimal trading path through Fibrous 's integrated liquidity sources to maximize output and minimize slippage. This endpoint is available across all supported networks.
