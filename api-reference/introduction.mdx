...
No authentication is required to use the Fibrous Router API. However, rate limits apply to ensure fair usage. API keys can be used for higher rate limits and to access integrator features (available on Monad V2 API).
