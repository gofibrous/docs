...
<Note>
  ...
  V2 API offers enhanced features including integrator fee support, improved response metadata, and new endpoints. Currently available on Monad network. See [V2 Migration Guide](/api-reference/v2-migration) for details.
</Note>
