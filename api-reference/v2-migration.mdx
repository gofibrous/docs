...
<Warning>
**API Key Required**: Integrator features require an API key from Fibrous. Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/).
</Warning>
...
<Warning>
**API Key Required**: To use integrator features, you must first obtain an API key from Fibrous. Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/).
</Warning>
...
<Warning>
**API Key Required**: Integrator parameters require an API key from Fibrous. Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/).
...
**Solution:** 
- **Obtain an API key**: Generate and manage your API keys at the [Fibrous Partnership Portal](https://portal.fibrous.finance/)
