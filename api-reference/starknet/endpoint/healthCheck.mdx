---
title: "Health Check"
description: "Check the health status of the Fibrous Starknet API"
...
Verify if the Fibrous Starknet API is up and running. This endpoint can be used for monitoring and ensuring the API service is healthy.
