---
title: 'Health Check'
description: 'Check the health status of the Fibrous Finance API'
api: 'GET /hyperevm/healthCheck'
---
...
<RequestExample>
```bash cURL
curl -X GET "https://api.fibrous.finance/hyperevm/healthCheck"
```

```python Python
import requests

url = "https://api.fibrous.finance/hyperevm/healthCheck"
...
axios.get('https://api.fibrous.finance/hyperevm/healthCheck')
...
- [Route](/api-reference/hyperevm/endpoint/route) - Find optimal swap routes
- [Calldata](/api-reference/hyperevm/endpoint/calldata) - Generate transaction data
