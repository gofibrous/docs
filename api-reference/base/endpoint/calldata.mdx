...
1. Always verify the `min_received` amount matches your expectations. Note that if integrator fees are used, `min_received` already accounts for the fee deduction.
