...
| tokenInAddress * | string | contract address of a token to sell e.g.: `0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` |
| tokenOutAddress * | string | contract address of a token to buy e.g.: `0xb8ce59fc3717ada4c02eadf9682a9e934f625ebb` |
...
| outputAmount | string | details of a token to buy |
| estimatedGasUsed | string | details of a token to buy |
