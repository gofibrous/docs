---
title: 'Calldata'
description: 'Generate calldata for the Fibrous router contract for swap on Citrea'
api: 'GET /citrea/calldata'
---
...
Generate the calldata required to execute a swap through the Fibrous router contract on Citrea. This endpoint provides the raw transaction data that can be used to execute the swap directly through a Web3 provider.

## Request Body Parameters

<ParamField body="route_response" type="object" required>
  The complete response object from the `/citrea/route` endpoint.
