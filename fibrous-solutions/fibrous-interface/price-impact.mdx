...
<Frame caption="Swap settings button on app.fibrous.finance">
  <img src="/images/price-impact/swap_settings.png" alt="Swap Settings Interface" />
</Frame>
...
<Frame caption="Do not forget to check slippage indicators on app.fibrous.finance">
  <img src="/images/price-impact/high_slippage.png" alt="High Slippage Risk Indicator" />
</Frame>
...
<Frame caption="Do not forget to check slippage indicators on app.fibrous.finance">
  <img src="/images/price-impact/medium_slippage.png" alt="Medium Slippage Risk Indicator" />
</Frame>
...
<Note>
Don't worry. We don't charge any fees for transactions on the Scroll network for now! Additionally, if you are a StarkRocks holder on the Starknet network, you can perform transactions on Fibrous without any service and gas fees.
</Note>
