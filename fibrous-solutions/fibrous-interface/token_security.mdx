...
| 0–19        | **LOW_RISK**      | <img   src="icons/LowRiskIcon.svg"   alt="Low Risk Icon"   width="24"   height="24" />           | Relatively safe tokens with minimal risk.                                                                          |
| 20–49       | **MEDIUM_RISK**   | <img   src="icons/MediumRiskIcon.svg"   alt="Medium Risk Icon"   width="24"   height="24" />     | Moderately risky tokens requiring caution.                                                                         |
| 50–99       | **HIGH_RISK**     | <img   src="icons/HighRiskIcon.svg"   alt="High Risk Icon"   width="24"   height="24" />         | High-risk tokens with significant security concerns.                                                               |
| 100\+       | **CRITICAL_RISK** | <img   src="icons/CriticalRiskIcon.svg"   alt="Critical Risk Icon"   width="24"   height="24" /> | The highest risk level, indicating critical security issue                                                         |
