...
Fibrous-widget package is an npm package of React components used to enable easy integration of Fibrous' functionality in a small and configurable user interface element.
